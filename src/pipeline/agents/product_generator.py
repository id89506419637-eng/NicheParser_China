...
- B2B-сегмент: бизнес, производство, HoReCa, строительство, ремонт, мебель для
  офисов/отелей. Можно дорогие реплики (диваны, часы, сумки) — это тоже B2B
  для перепродавцов. Избегай только обычного масс-маркета (одежда, косметика, БАДы).
